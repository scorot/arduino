 ...
 * controls a two relays that control an electric DC motor jack.
 * In addittion this version includes a switch to enable the user to choose between
...
void setup() {
  ...
  // Init pin for the manual switch
...
void loop() {
  ...
  // Read and print the statusof the manual switch
  ...
  if (buttonState == HIGH){
    // Case where we want automatic management
    Serial.print("\nAutomatic mode.");
